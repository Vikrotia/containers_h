...
TEST(map, mapEmplace) {
  ...
  std_map.merge(std_map2);
  my_map.insert_many(std::make_pair(42, "aaa"), std::make_pair(323, "dddsdar"),
                     std::make_pair(343, "cccaWD"), std::make_pair(-3, "ddd"));
